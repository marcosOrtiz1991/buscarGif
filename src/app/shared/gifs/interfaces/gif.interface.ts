// To parse this data:
//
//   import { Convert, SearchGifdResponse } from "./file";
//
//   const searchGifdResponse = Convert.toSearchGifdResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifdResponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifdResponse(json: string): SearchGifdResponse {
        return cast(JSON.parse(json), r("SearchGifdResponse"));
    }

    public static searchGifdResponseToJson(value: SearchGifdResponse): string {
        return JSON.stringify(uncast(value, r("SearchGifdResponse")), null, 2);
    }
}
